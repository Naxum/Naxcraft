...
public class NaxcraftSpawnCommand {
	public Naxcraft plugin;
	
	public NaxcraftSpawnCommand(Naxcraft instance){
		plugin = instance;
	}
	
	public boolean runSpawnCommand(CommandSender sender, String[] args){
		...
		if(plugin.control.has(player, "spawn")){
